...
class Session
{
    ...
    protected static $flashPrefixDefault = '__flash_';
    ...
    public function flashPrefix($prefix = null)
    {
        ...
        return $this->flashPrefix ?: $this->flashPrefix = static::$flashPrefixDefault;
    }

    public function flash($key, ...$values)
    {
        $key = $this->flashPrefix() . $key;
        ...
        if (\func_num_args() > 1) {
            return $_SESSION[$key] = \array_merge($flash, $values);
        }
